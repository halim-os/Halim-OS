...
$(() => {
    ...
    $("body").append(window["desktop"] = new Desktop({
        icons: [
            new DesktopIcon({ 
                id: "mycomputer", 
                icon: `https://img.icons8.com/?size=48&id=YCbKhwUNH1pc&format=png`,
                text: "My Work", 
                action: `Window.spawnWindow('explorer', { titlebar: 'My Computer', icon: '${base64_icon_mycomputer}', path: 'mycomputer' })`
            }),
            new DesktopIcon({
                id: "documents", 
                icon: `https://img.icons8.com/?size=48&id=Sf7hO9L4TEaQ&format=png`, 
                text: "My Skills", 
            ...
            new DesktopIcon({ 
                id: "msedge", 
                icon: `https://img.icons8.com/?size=48&id=GSr5Cwnbugpy&format=png`, 
                text: "Internet",
                url:`bing.com`,
               ...
               new DesktopIcon({ 
                id: "portofilo", 
                icon: `https://img.icons8.com/?size=48&id=MIRGw15n7f6c&format=png`, 
                url:"devart.bio/halimos",
                text: "My Portofilo", 
                action: `Window.spawnWindow('msedge')`,
            }),
              ...
              new DesktopIcon({ 
                id: "Certification", 
                icon: `https://img.icons8.com/?size=48&id=Mro5UCqHzkvz&format=png`, 
                url:"Behance.net",
            ...
            new DesktopIcon({ 
                  id: "ContactMe", 
                  icon: `https://img.icons8.com/?size=48&id=IvLlEwpWHgtg&format=png`, 
                  url:"Behance.net",
                  text: "Contact Me", 
                  action: `Window.spawnWindow('msedge')`,
              }),
              new DesktopIcon({ 
                  id: "BuyMeCoffee", 
                  icon: `https://img.icons8.com/?size=48&id=Ssu2jHhVZPnO&format=png`, 
                  url:"buymeacoffee.com/halimo.exe",
              ...
              new DesktopIcon({ 
                  id: "WorkTogether", 
                  icon: `https://img.icons8.com/?size=48&id=8Y1SrtCBXvmA&format=png`, 
                  url:"",
              ...
              new DesktopIcon({ 
                  id: "Freebies", 
                  icon: `https://img.icons8.com/?size=48&id=Xc1OKiNvz9vU&format=png`, 
                  url:"",
                  text: "Free Stuff", 
                  action: `Window.spawnWindow('msedge')`,
              }),
...
class ExplorerPane extends HTMLElement {
      ...
      html() {
            ...
            if(this.path == "mycomputer") {
                  res = [
                        new ExplorerIcon({ 
                              icon: `https://i.ibb.co/Pt0Fk0T/logo.png`,
                              text: "Logo Designer (C:)",
                              progress: true, 
                              subtext: "500GB free of 500GB",
                              percent:120,
                              action: `Window.spawnWindow('msedge')`,
                              url:`middlespot.com/halimos`

                        }),
                        new ExplorerIcon({ 
                              icon: `https://i.ibb.co/bgqCWRw/Video-on.png`,
                              text: "Video Editor (D:)",
                              progress: true, 
                              subtext: "400GB free of 500GB",
                              percent:100
                        }),
                        new ExplorerIcon({ 
                              icon: `https://i.ibb.co/nfcLjD4/Word.png`,
                              text: "UX / UI (E:)",
                              progress: true, 
                              subtext: "400GB free of 500GB",
                              percent:100
                        ...
                        new ExplorerIcon({ 
                              icon: `https://i.ibb.co/w6j5nFv/Terminal.png`,
                              text: "Developer (F:)",
                              progress: true, 
                              subtext: "480GB free of 500GB",
                              percent:120
                        }),
                        new ExplorerIcon({ 
                              icon: `https://i.ibb.co/FJ9K9Kd/Music.png`,
                              text: "Producer (G:)",
                              progress: true, 
                              subtext: "200GB free of 500GB",
                              percent:60
                        }),
                        new ExplorerIcon({ 
                              icon: `https://i.ibb.co/Qf2B3Tf/marketing.png`, 
                              text: "E-Marketer (H:)",
...
class ExplorerIcon extends HTMLElement {
      ...
      html() {
            return `
                  ...
                  <span>
                        ${this.text}
                        ${(this.progress ? `<div class='progress'><div style='width:${this.percent}px'></div></div>` : "")}
...
class App_Msedge extends HTMLElement {
      ...
      init() {
            ...
            setTimeout(() => {
                  ...
                  $(`#${this.wid}`).find(".msedge_tabs").append(`<w-edge-tab data-text="${LastClickedLink.split('.')[0]}" data-icon="${base64_search}"></w-edge-tab>`)
            }, 1)
      }
...
let wallpaper_dark = `https://mir-s3-cdn-cf.behance.net/project_modules/fs/3bf308139749731.623b1f74a45b2.jpg`

let base64_startbtn = `https://i.ibb.co/xDYnzLK/halimo-logo.png`
let base64_startbtn_dark = `https://i.ibb.co/xDYnzLK/halimo-logo.png`
